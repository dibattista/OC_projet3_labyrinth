...
class Object:
    ...
    def __init__(self, laby):
        ...
        self.needle_random_position = random.choice(self.store_empty_graphic_box())

        self.store_emptyBox.remove(self.needle_random_position)
        self.ether_random_position = random.choice(self.store_empty_graphic_box())

        self.store_emptyBox.remove(self.ether_random_position)
        self.pipe_random_position = random.choice(self.store_empty_graphic_box())
        ...
        """
              The constructor for Object class.
                ...
                self.needle_random_position (tuple): Tuple with two random int from empty box of the labyrinth
                remove self.needle_random_position to avoid duplicate
                self.ether_random_position (tuple): Tuple with two random int from empty box of the labyrinth
    ...
    def write_object_in_laby(self):
        """
            The method write in the labyrinth the objects with the value of their attributes.
            Returns:
